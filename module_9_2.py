...
# это сложнее... пока не дошло, что надо объединить две строки,  а не экспериментировать, "ломая" синтаксис языка
# объединяем строки first_strings + second_strings и работать будем с ОДНОЙ переменной
